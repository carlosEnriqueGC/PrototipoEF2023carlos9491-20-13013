...
namespace MenuHCV
{
    public partial class Menup : Form
    {
        ...
        public Menup()
        {
            ...
            Button[] apps = { btnseguridad, btncompras, btnVentas, btnInventario, btnBancos, btnNominas, btnHoteleria, btnPrototipo, btnPractica };
        ...
        {
            CapaVistaPractica.MDI_Practica form = new CapaVistaPractica.MDI_Practica();
            form.Show();
            cn.setBtitacora("9000", "Ingreso Compras");
        }
